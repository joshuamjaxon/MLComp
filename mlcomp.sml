...
open MLAS;
    ...
    (* The constants function is responsible for returning a list of all literal values in a program. 
     ...
     fun codegen(int(i),outFile,indent,consts,locals,freeVars,cellVars,globals,env,globalBindings,scope) = 
       ...
       | codegen(negate(t),outFile,indent,consts,locals,freeVars,cellVars,globals,env,globalBindings,scope) =
         let val _ = codegen(int("-1"),outFile,indent,consts,locals,freeVars,cellVars,globals,env,globalBindings,scope)
